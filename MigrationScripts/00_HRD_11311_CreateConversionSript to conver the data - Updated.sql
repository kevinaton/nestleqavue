...
CREATE TABLE [dbo].[HRD](
	...
	[BUManager] [nvarchar](50) NULL,
	[FertDescription] [nvarchar](50) NULL,
	[LineSupervisor] [nvarchar](50) NULL,
	[Area] [nvarchar](50) NULL,
	[AreaIfOther] [nvarchar](50) NULL,
	[AdditionalDescription] [nvarchar](75) NULL,
	[DetailedDescription] [nvarchar](75) NULL,

	[ContinuousRun] [nvarchar](10) NULL,
	[DateCompleted] [datetime] NULL,
	[NumberOfDaysHeld] [int] NULL,
	[Donate] [int] NULL,
	[Total] [int] NULL,
	[MonthHeld] [nvarchar](10) NULL,
	[WeekHeld] [int] NULL,
	[NumberOfDayToReworkApproval] [int] NULL,
	[CaseCount][int] NULL,
    [ReasonAction] [nvarchar](50) NULL,
    [IsApprovalRequestByQa] [bit] NULL,
    [IsPlantManagerAprpoval] [bit] NULL,
    [IsPlantControllerApproval] [bit] NULL,
    [IsDestroyed] [bit] NULL,
	[ApprovedByQAWho] [nvarchar](50) NULL,
	[ApprovedByQAWhen] [datetime] NULL,
	[ApprovedByPlantManagerWho] [nvarchar](50) NULL,
	[ApprovedPlantManagerQAWhen] [datetime] NULL,
	[ApprovedByPlantControllerWho] [nvarchar](50) NULL,
	[ApprovedByPlantControllerWhen] [datetime] NULL,
	[ApprovedByDistroyedWho] [nvarchar](50) NULL,
	[ApprovedByDistroyedWhen] [datetime] NULL,
	[Comments] [nvarchar](50) NULL,

	[CasesHeld] [nvarchar](50) NULL,
	[POs] [nvarchar](50) NULL,
	[PestType] [nvarchar](50) NULL,
	[PCOContactedImmediately] [nvarchar](50) NULL,
	[ProductAdultered] [nvarchar](50) NULL,
	[WhereFound] [nvarchar](50) NULL,
	[IfYesAffectedProduct] [nvarchar](50) NULL,
	[MaterialNumber] [nvarchar](50) NULL,
	[RawMaterialDescription] [nvarchar](50) NULL,
	[BatchLot] [nvarchar](50) NULL,
	[VendorNumber] [nvarchar](50) NULL,
	[VendorName] [nvarchar](50) NULL,
	[VendorSiteNumber] [nvarchar](50) NULL,
	[IsInspections] [bit] NULL,
	[IsXray] [bit] NULL,
	[IsMetalDetector] [bit] NULL,
	[FMType] [nvarchar](50) NULL,
	[Size] [nvarchar](50) NULL,
	[Equipment] [nvarchar](50) NULL,
	[EquipmentIfOther] [nvarchar](50) NULL,
	[ROHMaterial] [nvarchar](50) NULL,
	[PiecesTotal] [nvarchar](50) NULL,
	[RawBatchLot] [nvarchar](50) NULL,
	[HazardousSize] [nvarchar](50) NULL,
	[Responsibility] [nvarchar](50) NULL,
	[NonHazardousSize] [nvarchar](50) NULL,
	[DateReceived] [datetime] NULL,
	[InspectorsName] [nvarchar](50) NULL,
	[NRCategory] [nvarchar](50) NULL,
	[Tagged] [nvarchar](50) NULL,
	[TagNumber] [nvarchar](50) NULL,
	[Response] [nvarchar](50) NULL,
	[HoldConcern] [nvarchar](50) NULL,
	[DayOfWeek] [nvarchar](50) NULL,
	[When] [nvarchar](50) NULL,
	[WhenOther] [nvarchar](50) NULL,
	[DateOfResample] [datetime] NULL,
	[MeatComponent] [nvarchar](50) NULL,
...
GO
ALTER TABLE [dbo].[Security] ADD  CONSTRAINT [DF_Security_LaborCostList]  DEFAULT ((0)) FOR [LaborCostList]
GO
