  ...
  export default {
    ...
    data: () => ({
      ...
      access:{
        ...
        HRD:false,
        HRDApprovalRequestByQa:false,
        HRDApproveRework:false,
        HRDDelete:false,
        HRDDestroyed:false,
        HRDEdit:false,
        HRDEmailNotification:false,
        HRDPlantControllerApproval:false,
        HRDPlantManagerApproval:false,
        HRDRead:false,
        Labor:false,
        LaborEdit:false,
        LaborRead:false,
      ...
      permission:[
        ...
        'Pages.HRD', 
        'Pages.HRD.ApprovalRequestByQa',
        'Pages.HRD.ApproveRework', 
        'Pages.HRD.Delete', 
        'Pages.HRD.Destroyed',
        'Pages.HRD.Edit', 
        'Pages.HRD.EmailNotification', 
        'Pages.HRD.PlantControllerApproval',
        'Pages.HRD.PlantManagerApproval',
        'Pages.HRD.Read', 
        'Pages.Labor', 
        'Pages.Labor.Edit', 
        'Pages.Labor.Read', 
