...
namespace HRD.WebApi.Migrations
{
    ...
    [Migration("20220613092314_AddROHMaterial")]
    partial class AddROHMaterial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRD.WebApi.Data.Entities.Hrd", b =>
                {
                    ...
                    b.Property<string>("ReasonAction")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("HRD.WebApi.Data.Entities.HrdrohMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DropDownItemId");

                    b.HasIndex("Hrdid");

                    b.ToTable("HRDROHMaterial", (string)null);
                });
            ...
            modelBuilder.Entity("HRD.WebApi.Data.Entities.HrdrohMaterial", b =>
                {
                    b.HasOne("HRD.WebApi.Data.Entities.DropDownItem", "DropDownItem")
                        .WithMany()
                        .HasForeignKey("DropDownItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRD.WebApi.Data.Entities.Hrd", "Hrd")
                        .WithMany("HrdrohMaterials")
                        .HasForeignKey("Hrdid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DropDownItem");
